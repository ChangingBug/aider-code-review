...
DEFAULT_SETTINGS = {
    ...
    "aider_timeout": {"value": "600", "category": "aider", "description": "Aider执行超时时间(秒)"},
    "aider_retry_count": {"value": "1", "category": "aider", "description": "失败重试次数"},
    ...
    "polling_enabled": {"value": "false", "category": "polling", "description": "轮询是否启用(持久化状态)"},
}
